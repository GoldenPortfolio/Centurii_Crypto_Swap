const styles = {
  ...
  exchangeBoxWrapper: "mt-10 w-full flex justify-center margin-bottom-10px",
  exchangeBox:
  ...
  // WalletButton
  walletButton:
    "bg-orange-400 border-none outline-none px-6 py-2 font-poppins font-bold text-lg text-white rounded-3xl leading-[24px] hover:bg-orange-600 transition-all",
